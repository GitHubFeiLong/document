...
1.输入若干个数值存入数组中，采用冒泡算法进行升序或降序排序将下图所示，实现转置矩阵matrix.sh

2.打印杨辉三角形

https://ke.qq.com/webcourse/index.html#cid=445311&term_id=100532217&taid=3892846688390015&vid=5285890799486919207
